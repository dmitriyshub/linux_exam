...
: '
################################################
Hello and welcome to room 2 record data base!
you can choose action put of 8 actions.
Enjoy!
#################################################
'
...
function CheckString() {
    ...
    do
        read -p "Please enter the record name: " recName
...
#Author: Nir, Yulia, Yevgeni, Hadar
## 
